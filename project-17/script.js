...
{
    const bookDiv = document.createElement('div');//<div></div>
    // bookDiv.style.border = "2px solid red";
    bookDiv.style.cssText ="border:2px solid red;width:203px";
    const bookImage = document.createElement('img')//<img src="" alt="" />
    bookImage.src = bk.thumbnail // it assaigns bk.imagelink to src
    bookImage.alt = bk.title
    const title = document.createElement('h2')
    title.textContent = bk.title
    bookDiv.append(bookImage, title)
